...
try {
  ...
  assert.match(result.stdout, /13 files, 29 capabilities, 5 journeys, 5 studies/);
  ...
  assert.match(generated, /npx --yes web-app-security-skill@0\.7\.0 audit \. --fail-on never/);
