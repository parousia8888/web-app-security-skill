...
Phase 7 five-project candidate rerun is promoted into its active catalog. The final local candidate
gate, exact-commit CI/CodeQL, signed tag, GitHub Release, npm provenance, verified installer,
immutable Action consumer, signed `v1` promotion and durable live-verification record remain gated.
