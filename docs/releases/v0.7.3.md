...
Status: immutable release, npm package, verified installer and signed v1 published; Action consumer
...
same source commit. Both Action consumers and the durable live-verification record remain separate
gates.
...
- Signed annotated `v1` tag object `7bd05668153d21c1ac55ac35e8707703e2a6eb0f` was moved with an
  ...
  repository-local signer-policy verification passes. No Action-consumer or durable
  live-verification success is claimed until the combined workflow passes.
