...
Status: fully published and publicly verified.
...
installer trust anchors are recorded, clean-room installation passed and signed `v1` targets the
same source commit. Both Action consumers passed and the durable live-verification record is public.
...
- Verifier commit `ab80e144171b0e3ff350514c5d342e07737604fc` records all four release
  ...
  passed. Coordinated public-pin CI
  ...
  then passed.
- A fresh isolated home downloaded bootstrap commit
  `5de57e8a974247a2f519ac93cea580923aaaff6a`, matched SHA-256
  `2226efeed8127d2cd33fb05cbb0a3197952f8686d8ea9cf497bba1c6d33e6ef9`, verified the v0.7.3
  source archive and installed the Claude, Codex and CLI surfaces. All three returned
  `Web App Security Skill 0.7.3`. Attestation was explicitly `not run` in that isolated home because
  `gh` was not authenticated; authenticated verification already passed against the downloaded
  release archive.
- Signed annotated `v1` tag object `7bd05668153d21c1ac55ac35e8707703e2a6eb0f` was moved with an
  exact lease against prior object `758036ee84ad2bc2f31a8ba08969acd2a6b87de6`. It peels to source
  `28494afd3470897e9b25e7c90187eac35a016186`; GitHub reports `verified: true`, `reason: valid`, and
  repository-local signer-policy verification passes.
- Post-promotion CI
  ...
  passed. The one dispatched public consumer workflow
  [`32981490467`](https://github.com/parousia8888/web-app-security-skill/actions/runs/32981490467)
  passed its signed `v1` crawl consumer, immutable v0.7.3 route consumer and final live-verification
  job. The final job verified public Release/npm state and provenance, required installer
  attestation, and verified the moving alias.
- `web-app-security-skill-0.7.3.live-verification.json` is present as both workflow artifact and
  GitHub Release asset. Their bytes match at SHA-256
  `2bbfd428f853acf66caa3ec516d6b7e396f0f0eca78c84b4b46d9f05ebc5ca82`; all eight recorded gates
  are `verified`.
