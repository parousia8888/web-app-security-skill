...
Status: immutable release and npm package published. The signed tag, GitHub Release assets,
GitHub build provenance, npm package/provenance and exact-version npx consumer are verified.
Verifier/bootstrap trust publication and the immutable Action consumer are the remaining P15 gates;
signed `v1` promotion and durable live verification remain P16 gates.
...
and the immutable full-SHA Action consumer remain required before P15 closes.
...
- Current signed `v1` source before promotion: `28494afd3470897e9b25e7c90187eac35a016186`
- Final `v1` promotion and live-verification record: pending P16
