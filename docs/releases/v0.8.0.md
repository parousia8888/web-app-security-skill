...
Status: hosted release candidate. P0-P14 of the bounded interprocedural access-control plan are
complete. Signed tag, GitHub Release, npm provenance,
...
Hosted candidate verification passed before immutable publication:

- source commit: `988c0e910bf8389d5a27a561b22cf6e922711a4e`;
- [CI run 33263461118](https://github.com/parousia8888/web-app-security-skill/actions/runs/33263461118):
  `success` on macOS/Ubuntu with Node 22/24, including pinned real-adapter fixtures on Ubuntu Node 22;
- [CodeQL run 33263461143](https://github.com/parousia8888/web-app-security-skill/actions/runs/33263461143):
...
The tag-verification command remains pending until the SSH-signed annotated `v0.8.0` tag exists.
The tag triggers reproducible archive, SPDX SBOM,
