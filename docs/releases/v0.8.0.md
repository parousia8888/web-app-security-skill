...
Status: immutable release, npm package, verified installer and signed `v1` published. All P15
immutable-consumer gates passed. The combined immutable/`v1` consumer and durable live-verification
record remain the final P16 gates.
...
- Final combined consumer and live-verification record: pending P16
