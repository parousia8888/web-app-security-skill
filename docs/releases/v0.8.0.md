...
Status: immutable release and npm package published; all P15 immutable-consumer gates passed. The
signed tag, GitHub Release assets, GitHub build provenance, npm package/provenance, exact-version
npx consumer, public verified installer and full-SHA Action consumer are verified. Signed `v1`
promotion and durable live verification remain P16 gates.
