...
the published v0.7.3 release it runs 25 built-in risk rules and 3 evidence-integrity rules, with
...
Download every v0.7.3 asset, verify the checksums, extract the archive and install from that verified
payload:
