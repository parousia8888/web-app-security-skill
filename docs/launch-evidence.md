...
| Release | v0.6.0 signed tag, reproducible archive, SPDX SBOM, checksums, manifest and provenance | [v0.6.0 release](https://github.com/parousia8888/web-app-security-skill/releases/tag/v0.6.0) |
