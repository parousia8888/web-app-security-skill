...
| Release | v0.8.1 signed tag, reproducible archive, SPDX SBOM, checksums, manifest and provenance | [v0.8.1 release](https://github.com/parousia8888/web-app-security-skill/releases/tag/v0.8.1) |
