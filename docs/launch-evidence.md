...
| Release | v0.7.3 signed tag, reproducible archive, SPDX SBOM, checksums, manifest and provenance | [v0.7.3 release](https://github.com/parousia8888/web-app-security-skill/releases/tag/v0.7.3) |
