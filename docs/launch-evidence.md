...
| Release | v0.5.4 signed tag, reproducible archive, SPDX SBOM, checksums, manifest and provenance | [v0.5.4 release](https://github.com/parousia8888/web-app-security-skill/releases/tag/v0.5.4) |
