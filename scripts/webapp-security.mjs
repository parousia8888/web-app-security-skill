...
const include = [
  ...
  'docs/adapter-protocol.md', 'docs/alert-policy.md', 'docs/release-trust-boundaries.md',
  ...
  'docs/reviews/v0.8.0-access-control-review.md',
  'docs/reviews/v0.8.0-access-control-review-provenance.json',
  'docs/reviews/v0.8.0-access-control-review-provenance.md',
